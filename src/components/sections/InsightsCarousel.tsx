...
const INSIGHTS_SLIDES: {
...
}[] = [
  {
    ...
    copy: "Every opportunity on ELEVEN goes through verification. You know what they want, what they pay, and who you're working with. Your time matters.",
  },
  {
    icon: HiDocumentText,
    ...
    copy: "No back-and-forth. On ELEVEN the brief is set: deliverables, deadlines, and compensation. You focus on creating.",
  },
  {
    icon: HiBanknotes,
    ...
    copy: "ELEVEN standardizes timelines and payment terms. Less stress, more time for what matters: your content.",
  },
  {
    icon: HiUserGroup,
    ...
    copy: "On ELEVEN you're not alone. You're with people who live the same reality: opportunities, learnings, and support when you need it.",
  },
  {
    icon: HiGlobeAlt,
    ...
    copy: "ELEVEN connects with brands that already trust the ecosystem. You show up on their radar with a profile that speaks for itself.",
  },
  {
    ...
    copy: "ELEVEN has training built for creators: monetization, negotiation, metrics. And support when you need it.",
  },
];
