...
export function HowElevnWorksSection() {
  ...
  // Section hidden: replaced by ElevnStudioSection (same visual, learning content). Set to true to restore.
  const SHOW_HOW_ELEVN_WORKS = false;
  if (!SHOW_HOW_ELEVN_WORKS) return null;
