      ...
      <div className="relative z-20 flex flex-col justify-between px-7 pt-24 pb-10 lg:col-span-5 lg:min-h-screen lg:px-12 lg:pt-36 lg:pb-14 xl:px-16 xl:pt-40">
        ...
        >
          ...
          <div className="space-y-5 lg:space-y-6">
            ...
            ELEVEN is your direct access to premium campaigns, elite training, and the most powerful creator community in the region. If you take your content seriously, you belong here.
            </p>
